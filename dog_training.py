...
import  dog_train_data as train_data
import  cv2
import  random
...
images_input = tf.placeholder(tf.float32,[None,64*64*3],name='input_images')
...
x_input = tf.reshape(images_input,[-1,64,64,3])
...
saver.save(sess, './model/my-dog-v1.0')
